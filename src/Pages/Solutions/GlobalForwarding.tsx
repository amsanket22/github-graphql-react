            ...
            <div className="relative max-w-[90rem] mx-auto p-4">
                <div className='py-4 mt-12 max-w-[60rem] border-l-4 border-l-orange-600'>
                    ...
                    <p className='ml-4 text-5xl font-medium'>
                        ...
                        Global freight forwarding field, we secure your
                        logistics need in cross border transportation at
                        the shortest lead time possible, leveraging the
                        Hitachi Transport System Group offices (HTS) &
                ...
                <div className='p-5 mt-10'>
                    ...
                    <p className='mt-2 text-lg leading-8 '>
                        We are a team of specialized industry professionals
                        having ability to handle shipments end to end across
                        the Globe, covering every logistical needs. Our global
                        network, with options of multiple modes of transportation,
                        enables us to provide fast, efficient, cost-effective solutions.
                        Coupled with our process-oriented approach, enhanced
                        IT capabilities, strong customer focus, delivers the
                        most effective & efficient shipping option available.
                    </p>
                </div>
                <img src={image1} alt="" />
                ...
                <div className='mt-10'>
                    ...
                    <div className='grid grid-cols-2 py-12'>
                        <div className='py-20'>
                            ...
                            <div className='max-w-[30rem] leading-loose'>
                                <p className='mt-12'>
                                    Our presence in all major airport/gateways enables
                                    the best optimized solutions for on time pick
                                    up/deliveries at any part of the globe. Our large
                                    scale of operation and strong carrier relationship
                                    enable us in securing competitive price & space.
                                </p>
                                <p className='mt-8'>We offer a wide range of Import & Export consolidation
                                    services, solution for Door to Door movements, Temperature
                                    control cargo, DG Cargo, ODC, Flight Chartering &
                                    Domestic Air freight.
                                </p>
                                <p className='mt-8'>We provide seamless real-time visibility across,
                                    using our IT system with auto updates from airlines.
                                </p>
                            </div>
                        </div>
                        <img src={image2} alt="" />
                    ...
                    <div className='grid grid-cols-2 py-12'>
                        ...
                        <div className='py-20'>
                            ...
                            <div className='max-w-[30rem] leading-loose'>
                                <p className='mt-12'>
                                    We provide flexible, dependable, and secure Ocean
                                    freight solutions with our strong and long-term
                                    carrier partnerships across the Globe. We specialize
                                    in providing Direct and Multicountry consolidations
                                    services, FCL, LCL Consolidations, Door to Door services,
                                    Reefer containers, Special Equipment's, ODC &
                                    Project cargo, Break-bulk, RO-RO, ship chartering.
                                </p>
                                <p className='mt-8'>We provide schedule for planning, real-time updates, alerts, status of container till delivery.
                                </p>
