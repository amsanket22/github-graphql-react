...
const navigation = {
    solutions: [
        ...
        { name: 'IT Enabled Services', href: '#' },
        { name: 'Integrated Logistics Solutions', href: '#' },
                    ...
                    <div className="grid grid-cols-2 gap-8 mt-12 xl:mt-0 xl:col-span-2">
                        <div className="md:grid md:grid-cols-2 md:gap-8">
                            ...
                            <div className="mt-12 md:mt-0">
                                <h3 className="text-sm font-semibold tracking-wider text-gray-400 uppercase">Industry</h3>
                                <ul className="mt-4 space-y-4">
                        ...
                        <div className="md:grid md:grid-cols-2 md:gap-8">
                            <div>
                                <h3 className="text-sm font-semibold tracking-wider text-gray-400 uppercase">About Us</h3>
                                <ul className="mt-4 space-y-4">
                ...
                <div className="pt-8 mt-12 border-t border-gray-200">
                    <div className="flex justify-around">
                        <div className="flex">
                            ...
                            <span className="text-base text-gray-400 xl:text-center">Privacy Policy</span>
                            <div className="w-px h-6 ml-6 mr-3 bg-gray-300"></div>
                            <span className="text-base text-gray-400 xl:text-center">Terms And Conditions</span>
                        </div>

                        <p className="text-base text-gray-400 xl:text-center"> Copyright &copy; {getCurrentYear()} Flyjac Logistics, All rights reserved.</p>
                    </div>
                </div>
            </div>
        </footer >
